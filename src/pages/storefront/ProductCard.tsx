      ...
      <div>
        ...
        <div className="p-3 sm:p-5">
          <div className="flex items-center justify-between mb-1">
             {product.vendor && <div className="text-[11px] sm:text-xs font-bold text-blue-600 truncate mr-1.5">{product.vendor}</div>}
          ...
          <div className="mb-1.5 flex flex-wrap items-center gap-1">
            {product.category && (
              <span className="px-1.5 py-0.5 bg-slate-100 text-slate-700 font-bold text-[9px] sm:text-[10px] rounded border border-slate-200">
                {product.category}
              </span>
            )}
            {product.brand && (
              <span className="px-1.5 py-0.5 bg-purple-50 text-purple-700 font-bold text-[9px] sm:text-[10px] rounded border border-purple-100">
                {product.brand}
              </span>
            )}
          </div>
          ...
          <h3 
            className="font-bold text-slate-900 text-xs sm:text-sm mb-1 cursor-pointer hover:text-blue-600 line-clamp-2 transition-colors min-h-[2rem]" 
            onClick={handleProductClick}
          >
            {product.name}
          </h3>
